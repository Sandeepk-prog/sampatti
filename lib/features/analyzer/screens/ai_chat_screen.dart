              ...
              child: Row(
                ...
                children: [
                  ...
                  /*GestureDetector(
                    onTap: () {},
                    child: const Padding(
                      padding: EdgeInsets.only(bottom: 12, left: 8, right: 4),
                  ...
                  GestureDetector(
                    ...
                    child: const Padding(
                      padding: EdgeInsets.only(bottom: 12, left: 8, right: 4),
                      child: Icon(LucideIcons.mic, color: AppColors.textSecondary, size: 20),
                    ),
                  ),*/
                ],
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (isAI && message.widgetData != null) ...[
                   ...
                   /* Surface(
                      catalog: chatCatalog,
                      data: message.widgetData!, surfaceContext: null,
                    ),*/
...
class _FormattedText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Simple markdown support for bolding **text**
